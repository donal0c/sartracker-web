...
const bindings = [
  ...
  { contractId: 'C29', variantId: 'human-acceptance', mandatory: true, phase: 'prepublication' },
...
describe('mandatory release phases', () => {
  ...
  it('admits C27 only after every other required contract and C29 pass', () => {
  ...
  it('admits C00 only after C27/C29 and the exact scope-limited prepublication result', () => {
