  ...
  return <div className="space-y-4" data-testid="search-operations-workspace">
    ...
    {props.operations.areas.length > 0 ? <section className="rounded-2xl border border-stone-800 bg-stone-900/30 p-5" data-testid="search-operation-entry">
      <div className="grid gap-3 md:grid-cols-2">
        ...
        <input className="rounded-lg border border-stone-700 bg-stone-950 px-3 py-2 text-sm text-stone-100" data-testid="search-operation-coordinator" onChange={(event) => setCoordinatorName(event.target.value)} placeholder="Coordinator name" value={coordinatorName} />
        <input className="rounded-lg border border-stone-700 bg-stone-950 px-3 py-2 text-sm text-stone-100" data-testid="search-assignment-team" onChange={(event) => setTeamId(event.target.value)} placeholder="Team / group identity" value={teamId} />
      ...
      <div className="mt-5 grid gap-3 md:grid-cols-2">
        ...
        <input className="bg-stone-950 p-2" data-testid="search-pass-participants" onChange={(event) => setPassParticipantIds(event.target.value)} placeholder="Participant IDs, comma separated" value={passParticipantIds} />
        <input className="bg-stone-950 p-2" data-testid="search-pass-clues" onChange={(event) => setClueIds(event.target.value)} placeholder="Clue IDs, comma separated" value={clueIds} />
