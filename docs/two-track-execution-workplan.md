...
| Active | 3-6-26 team feedback intake | Track A / Shared | `DON-83` | Parent for fresh team-reported bugs and requests from `team-feedback/3-6-26Updates.odt`. `DON-86` through `DON-90` are complete and verified. `DON-99` and `DON-100` are blocked pending coordinator/team clarification. Continue the remaining unblocked children by priority unless Donal redirects. |
