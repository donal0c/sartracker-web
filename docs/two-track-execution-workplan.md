...
`docs/breadcrumb-pr3-t1-evidence.md`. G3 now blocks the separate final
coverage + mission-model default-flip commit.
...
| Active — G3 | PR-3: decide and deliver complete mission coverage | Shared Tracking / S2 Electron / Coverage / Verification | `DON-273` / `DON-276` / `DON-275` | Candidate B is ratified; `DON-273` and BCP-08 / `DON-276` are complete. BCP-09's flag-on UI/manual and the exact-head T1 software, package, 3.704 GB migration, and packaged CI-soak gates pass at tested code head `d1e884b`. `docs/breadcrumb-pr3-t1-evidence.md` binds the result. G3 now blocks the separate coverage + mission-model default flip; five independent exact-head reviews follow that commit. |
