...
| Recovery in flight; final exact-head proof pending | [PR #10](https://github.com/donal0c/sartracker-web/pull/10): PR-6 archive lifecycle | S2 Electron / Archive / Mission Review / Verification | `DON-248` / `DON-252` / `DON-253` | Heads `caf9e5e8…`, `49523dc8…`, local `81e47973…`, local `74bdd95…`, local `6a72ae91…`, local `23161300…`, pushed `d91ec232…`, and pushed `7e0d8ea3…` are rejected diagnostics. Caf9 crossed 5.24 GB but failed teardown/liveness. D91 exposed private-operation/public-projection and empty-participant readiness false negatives. Candidate 7e then passed exact package/lifecycle, Chromium `173/173`, visual `62/62`, uncached visual review `74/74`, and physical SIGKILL `32/32`, but final review found same-name mission identity, rendered-device identity, and sealed-archive recovery-readiness gaps; Linux run `33938682590` was cancelled and is not evidence. The current red-first successor binds the original mission UUID, requires the exact durable and rendered device before liveness attribution, projects public archive rows through the production IPC boundary, and requires coherent recoverable v2 slot semantics before accepting sealed or verified custody. The shared projector is included in the five-file harness identity. Existing continuity, source, main, renderer, cleanup, terminal-artifact, audit/custody, and strict `>=200 ms` fail-closed gates remain unchanged. Current dirty-tree verification is `4/97` focused, full serial `375/3,770`, full ESLint, production build/budgets, Node/diff checks, backend `58 + 1 ignored`, and clean bounded re-audits. Replacement exact-head package/lifecycle, browser/visual, physical kill matrix, Linux, four final reviews, and exactly one fresh controlled greater-than-2-GiB qualifier remain pending. Pre-merge proof is not release or field acceptance. |
