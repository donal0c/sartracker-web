...
| Active | 6-6-26 team feedback implementation batch | Track A / Shared | `DON-117` | Fresh ODT copied to `team-feedback/6-6-26.odt` and extracted to text/Markdown/assets. Immediate Todo children: `DON-118`-`DON-133`; coordinator-confirmation Backlog children: `DON-134`-`DON-140`. Existing `DON-100` updated with repeated multi-day mission feedback. Start with `DON-118`, then safety-critical `DON-123` and `DON-124`, before the remaining Todo children by priority/reproduction evidence. |
