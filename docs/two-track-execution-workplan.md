...
| Backlog | Decide archive encryption, authenticity, custody, and emergency access | S2 Electron / Archive / Governance | `DON-248` | BCP-14 in the breadcrumb archive-lifecycle stage; the earlier bounded-store architecture is now locked in the breadcrumb ADR. |
...
| Backlog | Create streamed encrypted mission archives with restore-and-replay proof | S2 Electron / Archive | `DON-252` | BCP-15 in the breadcrumb archive-lifecycle stage; no whole shared DB in memory or unrelated missions in an archive. |
| Backlog | Add archive-backed review, visible revisions, and indefinite retention | S2 Electron / Governance | `DON-253` | BCP-16 in the breadcrumb archive-lifecycle stage; archive bytes stay immutable and evidence has no permanent deletion path. |
