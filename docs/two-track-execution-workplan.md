...
1. Execute the **Breadcrumb and Mission-History Programme** under the locked ADR and `docs/breadcrumb-programme-execution-policy.md`. PR-1 through PR-4 are merged. PR-5 mission evidence/replay (`DON-274`, `DON-277`, `DON-278`, `DON-279`) remains one review unit on `codex/breadcrumb-pr5-evidence-replay` from exact merged PR-4 base `80309c995a18eeb190cce4310c9a46b0f46d5263`. Exact head `a584b2aa` passed Linux run `33207406645` but all four independent reviewers rejected it. Central retrace accepted five P2s spanning unbounded mutable evidence, synchronous 500k legacy-event migration, non-atomic receipt recovery, a Tauri Finish/delete race, and default Replay paging context. Executable remediation `12532025` closes all five and is locally green through 294 files / 2,484 tests, backend 57/1, Chromium 167/167, visual 58/58 plus uncached 69/69 review, indexed 960k qualification and two-launch packaged soak. Documentation binding, push, fresh exact-head Linux and a restarted broad/persistence/concurrency/renderer wave remain task-owned completion gates. PR-6 archive lifecycle follows only after Donal accepts PR-5.
