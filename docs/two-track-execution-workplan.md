...
| In progress | PR-1: trustworthy ingest and live safety; complete candidate integration | Shared Tracking / S2 Electron / Evidence | `DON-266` / `DON-267` / `DON-268` / `DON-269` | Branch `codex/breadcrumb-pr1-ingest-safety`; BCP-10 exact Dots and BCP-01 current-position safety remain green. BCP-02 adds schema v8 provenance, immutable first-accepted-wins conflict evidence, durable rejection outbox, persistent degraded health, and completion guards. BCP-05 adds accuracy-aware stationary attention with additive map/UI presentation and acknowledgement. Focused `269/269`, BCP-10 `10/10`, Chromium `4/4`, and three critical visual reviews pass. Final full/package/migration/soak gates and PR closeout remain; no team release comes from this PR. |
