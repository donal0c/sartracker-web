...
1. Execute the **Breadcrumb and Mission-History Programme** under the locked ADR and `docs/breadcrumb-programme-execution-policy.md`. PR-1 through PR-5 are merged. Breadcrumb programme PR-6—the archive-lifecycle stage owned by `DON-248`/`DON-252`/`DON-253` and distinct from merged WAR-01 GitHub PR #6—is in review as [PR #10](https://github.com/donal0c/sartracker-web/pull/10). The prior candidate proofs and initial reviews are superseded by red-first remediation now frozen at `f220f59650ba96231f06a4f45015791223934300` (tree `9b5bf3a24da9a4ba6e98e8ee3e21d7ba236e6538`); the deterministic suite is green at `359 files / 3,404 tests`, with lint and build green. Exact-head Ubuntu greater-than-2 GiB, browser/package/Linux proof, and the required five-charter review/recheck ledger remain completion gates. This is pre-merge engineering proof, not release or field acceptance. Donal retains approval/merge authority. After the exact merged head exists, run WAR-04B's narrow refresh before any release decision. BCP-17 must qualify one exact final candidate before `DON-255` may publish it.
...
| In review | [PR #10](https://github.com/donal0c/sartracker-web/pull/10): PR-6 archive lifecycle | S2 Electron / Archive / Mission Review / Verification | `DON-248` / `DON-252` / `DON-253` | Prior candidate proofs are superseded by red-first remediation at `53164028f72254c4e17fcc0b4b845f7601fee153` / tree `5c347d30691f291164dc65ed25c2bc437f906e55`; deterministic `359 files / 3,399 tests`, lint and build are green. A new frozen candidate plus Ubuntu >2 GiB, exact-head browser/package/Linux proof, final-head rechecks and five exact-head reviews remain mandatory before Donal's approval/merge. Pre-merge proof is not release or field acceptance. |
