...
BCP-08 is now active in the accepted strict red-first sequence. G3 still blocks
the separate final default-flip commit.
...
| Active | PR-3: decide and deliver complete mission coverage | Shared Tracking / S2 Electron / Coverage / Verification | `DON-273` / `DON-276` / `DON-275` | G2's 18-run reference-host matrix selected Candidate B, and Donal ratified B plus the unchanged budgets on 2026-08-24. `DON-273` is complete; BCP-08 / `DON-276` is active. G3 still blocks the separate default flip. |
