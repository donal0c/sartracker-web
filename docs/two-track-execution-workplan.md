...
| Active | Qualify beta.12 CI artifact on Ubuntu and original field machine | S2 Electron / Release | `DON-247` | Exact replacement CI artifact `fb6c4922…` from green run `29127625505` passed three Ubuntu field runs, both multi-day soaks, and the full packaged smoke/diagnostics matrix. Only original-machine/profile confirmation and support-bundle collection remain. |
