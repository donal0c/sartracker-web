...
| Active | Qualify beta.12 CI artifact on Ubuntu and original field machine | S2 Electron / Release | `DON-247` | Version/release note prep is active; next is the exact tag-built artifact, three consecutive Ubuntu passes, full packaged smoke and both multi-day profiles, then original-machine confirmation. |
