...
- Recommended action: commit and push the code-and-documentation head, repeat macOS/Linux package gates on it, and complete five fresh independent reviews. Do not merge or release from this implementation task.
