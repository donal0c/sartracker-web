...
- Recommended action: commit and push the lifecycle remediation, run replacement exact-head macOS/Linux package and soak proof, bind that evidence in a documentation-only descendant, then complete five fresh independent reviews from zero. Do not merge or release from this implementation task.
