...
- Recommended action: commit and push the finished-mission teardown remediation, repeat macOS/Linux package gates, bind that exact evidence in a documentation-only descendant, then complete five fresh independent reviews from zero. Do not merge or release from this implementation task.
