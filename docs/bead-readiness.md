...
- Implementation readiness: implementation, G2/G3, migration, rebound Candidate-B rows, exact-production qualification, and the rebound packaged soak are complete; final documentation-head gates and five reviews remain.
- Recommended action: run the final exact-head software/browser/visual/package gates, then complete all five independent reviews before opening the PR.
...
- Ready-to-start checklist: [x] accepted plan and requirement trace; [x] exact base; [x] G2 ratification and affected-row rerun; [x] BCP-08; [x] flag-on BCP-09 implementation/manual; [x] T1 migration and rebound soak; [x] G3; [x] separate default flip; [ ] final exact-head gates; [ ] five exact-head reviews.
