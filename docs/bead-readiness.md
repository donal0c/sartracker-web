...
- Evidence: G2's prescribed 18 serial packaged runs completed on the Ubuntu reference host at measured SHA `8eff87b724ae6`; B alone passed 960k and 2M. The latest review-driven two-phase handoff remediation reran B's six rows plus two kill probes at `17e75f2`; both scales passed unchanged budgets. The committed production driver at that exact code head delivered 959,988/959,988 and 1,999,988/1,999,988 through staged read, activation, active read, and finalization at 2.317/4.527 s first useful, 6.077/12.084 s complete, and 15.884/23.219 ms main gaps. The single replacement packaged CI soak passed 8,664/8,664 fixes, restart, zero redundant slope, 9.099 ms main / 100.3 ms renderer maxima, 1.116 GB peak RSS, and a 32-chunk/zero-invalidation ledger. The 16.557 ms integrity-`ok` 3.704 GB v9→v10 migration retaining 2.04M positions remains standing because schema/open code did not change. Full bindings and proof limits are in `docs/breadcrumb-pr3-t1-evidence.md`.
