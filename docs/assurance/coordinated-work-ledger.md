...
| --- | --- | --- | --- | --- |
| `AUD-07` hidden evidence remains selectable | P2 | **Fold into active DON-256 Team Feedback Batch 2** | Same visibility and Review-map boundary; coordinator brief sent to task `01a0877d-31a2-73d0-b17f-21d6d953880b` | Exact-head red/green rendered interaction proof and inclusion in the batch's existing independent review |
| `AUD-14` failed history retrieval coexists with “All mission history shown” | P2 | **Fold into active DON-256 Team Feedback Batch 2** | Same completeness/progress and Mission Review boundary; no source arithmetic change | Exact-head failure-state test proving no unqualified completeness claim, plus existing batch review |
