...
| `WAR-06-AUD-01`, `WAR-06-AUD-02`, `WAR-06-CACHE-SIBLING` lifecycle/cache boundary | P1 | **Local repair verified and independently reviewed; exact-head PR CI required before Donal merges** | `DON-267` In Progress; `codex/don-267-war06-mission-scope-repair` from merged PR24 `deedab27`; DON-254 is the separate recovery/qualification owner | Original three routes and review-added queue/cache/context races retain RED/GREEN. Final focused 232 tests, two browser flows, lint/build and five-launch mac-arm64 packaged cache smoke pass. Serial source cycle before final refinement passed 4,662 tests with six named timing exclusions. Both source reviews clear; exact-head ordinary CI remains the merge gate. Four broader browser failures reproduce on baseline; native coverage warnings retained. Original PR1/PR4/PR17 fixes remain valid; release HOLD. [Production repair](findings/war-06/mission-scope-repair.md) · [Historical investigation](findings/war-06/WAR-06.md) |
