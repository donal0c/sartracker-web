...
| C03/C11/C17 | Scoped outing/known-at, 50k search-pass and raw recursive diagnostics probes, with retained ASAR/raw-byte custody | C03/C11 development passed; C17 raw synthetic-secret leak correctly fails; future exact Linux package execution required |
