...
- **Breadcrumb PR-1 review candidate (2026-08-22):** `codex/breadcrumb-pr1-ingest-safety` now contains BCP-10/01/02/05. Schema v8 adds exact accepted-position provenance, an immutable first-accepted-wins conflict rule, an atomic anomaly ledger, and a crash-safe acked rejection outbox. Current positions never wait for it; persistent degraded evidence health blocks finalization/archive export and leaks no anomaly content into diagnostics. Accuracy-aware stationary attention is derived from accepted fixes, recomputes from hydrated history, adds a map ring without replacing the marker, and supports presentation-only acknowledgement. Focused policy/fault/restart/settings/map/UI tests, targeted Chromium `4/4`, three fresh critical visual reviews, BCP-01 regression `269/269`, and BCP-10 `10/10` are green. Final full gates, packaged v7→v8 proof, packaged CI-scale soak, push, and PR creation remain before review-ready handoff. No live-provider, field, deployment, merge, or release proof has been run.
