...
- **PR5 mission evidence and replay is replacing exact head `355c495cb65e26a85e1adbf6d850fa500a9b286b`:** broad life-safety and persistence/completeness review were clean there, but concurrency/finalization and renderer/input-containment found a nondeterministic Chromium `datetime-local` format, permissive pass timestamps and an unbounded Search Operations write envelope. The real control/store reproductions are now covered: canonical fractional seconds, calendar-valid explicit-offset pass instants, Electron/browser/UI bounds, and a 32 MiB note rejected before persistence inside the 200 ms current-position gate. The earlier transaction-current GPX retirement audit, mission/outing/wall-clock pass bounds, and outing/assignment anti-stranding fences remain intact. Replacement proof is focused units 70/70, Search Operations Chromium 10/10 sequential, full unit 288 files/2,403 tests, backend 51/1 intentional ignore, lint/build/budgets, Chromium 164/164, visual 58/58 and fresh uncached independent visual review 69/69 (`visual-review-2026-08-28T01-05-16Z.json`). Because the remediation crosses renderer input and backend persistence, the fresh broad review plus persistence, concurrency and renderer focused rechecks are all required on one pushed exact code-and-documentation head. PR opened/review-ready remains intermediate; do not merge or release.
