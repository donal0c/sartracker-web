...
- **Breadcrumb PR-3 final review remediation (2026-08-25):** branch `codex/breadcrumb-pr3-complete-coverage` remains based on exact PR-2 merge `7021fc1e`; Candidate B and both G2/G3 approvals remain binding. The latest review wave's cancellation, obsolete-finalization, partial-style, worker-loss restoration, detached-operator-state, and qualification-attestation gaps are fixed red-first at `37ea0b4` / `df61a02`. Focused green is 49/49; full serial unit is 2,051/2,051; lint, TypeScript, CommonJS, exact Dots 10/10, build/budgets, Ubuntu Chromium 158/158, coverage visual 6/6, and fresh critical review 8/8 pass. Exact production qualification now proves all 13 periods with non-empty decoded geometry before/after activation: 959,988/959,988 and 1,999,988/1,999,988 delivered at 2.245/4.534 s first useful and 21.026/21.825 ms main gaps. G2, the single packaged soak, and the 3.704 GB migration remain standing under their explicit invalidation rules. Next: commit the evidence binding, repeat exact-head deterministic/Chromium/visual/macOS+Ubuntu package gates, then restart all five reviews.
...
- **Breadcrumb coordination workflow:** one implementation task owns complete PR-3 through BCP-07 → BCP-08 → BCP-09. G2/G3 are approved. Final exact-head gates and five freshly restarted independent reviews remain before the PR opens.
