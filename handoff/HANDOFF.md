...
- **Breadcrumb PR-3 G2 ratified; BCP-08 active (2026-08-24):** branch `codex/breadcrumb-pr3-complete-coverage` started from exact base `7021fc1e`. The prescribed 18-run packaged matrix at measured SHA `8eff87b...` selected Candidate B (SQLite-backed local vector tiles); B alone passed 960k and 2M. Donal ratified B and the unchanged 1.5 GiB settled-at-960k / 2.5 GiB peak-at-2M memory gates against decision head `934cf542eaad5734982cb53c06701462c7ab212c`. All 18 runs, six kill proofs, nine-pane attestations, B invalidation falsifiers, and exact Dots `10/10` passed; evidence manifest SHA-256 is `470449f7...c980`. Decision memo: `docs/breadcrumb-coverage-renderer-decision.md`. BCP-08 now proceeds in the accepted strict red-first sequence; G3 still blocks the separate final default flip.
