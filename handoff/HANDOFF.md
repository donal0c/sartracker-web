...
- **Breadcrumb coordination workflow:** one implementation task owns the complete PR-3 through BCP-07 → BCP-08 → BCP-09. G2 is ratified and T1 is green; G3 alone blocks the separate final default flip.
