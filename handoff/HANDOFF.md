...
- Artifact SHA256s recorded in the bead `sartracker-web-y6a` final comment for audit; the `SHA256SUMS` asset on the published release is the source of truth.
