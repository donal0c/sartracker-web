...
- **PR5 mission evidence and replay is replacing another rejected review head:** `dace08e2c2da5867cf463a0e262bcbf7ad6ee764` retained the safe retirement-wins publication fence and received clean persistence/completeness and renderer/input-containment reviews, but broad and concurrency reviews found two P2s. Retirement could audit a superseded GPX revision when publication won immediately before its transaction, and Search Operations accepted pass times outside the selected assignment outing. Both were reproduced red. Retirement now reads/mutates/audits the transaction-current revision; pass intervals are fail-closed against mission, outing and wall-clock bounds, and later outing/assignment edits cannot strand retained passes. Replacement-tree proof is full unit 288/2,400, backend 51/1 intentional ignore, lint/build/budgets, Chromium 164/164, visual 58/58 and fresh uncached visual review 69/69 (`visual-review-2026-08-28T00-36-12Z.json`), in addition to the unchanged 960k/2m, macOS soak and forced-kill evidence. Fresh exact-head Linux qualification and the affected review topology remain required. PR opened/review-ready remains intermediate; do not merge or release.
