...
- **Latest test counts:** 151 unit files / 951 tests; 118 standard Playwright E2E; 47 backend tests.
...
DON-193 Tracking stale-state visibility and map-label readability — **DONE locally; ready to commit/push.**
