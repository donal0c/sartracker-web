...
- **PR5 mission evidence and replay is replacing a concurrency-rejected head:** heads through `d57084b95dd208f68690d367533238bbe42a734e` were rejected with every accepted finding reproduced red and documented. Broad, persistence and renderer reviews were clean on `dfde1d8f17eff3fdd9205634494255f3ce43395c`, but concurrency review proved that a chunked GPX replacement could overwrite an operator retirement committed during writer yields. The final publication transaction now revalidates the live import, removes a losing staged revision, records one explicit retained-source failure and never reactivates retired evidence; the controlled race is red-green. Replacement-tree verification is full unit 288/2,398, backend 51/1 intentional ignore, lint/build/budgets, Chromium 164/164, visual 58/58, fresh uncached visual review 69/69, 960k/2m scale with all 200 ms gates, macOS package soak 6/6 and authentic-960k `backup:started` kill/restart recovery. Fresh exact-head Linux qualification and all four independent exact-head reviews remain required. PR opened/review-ready remains intermediate; do not merge or release.
