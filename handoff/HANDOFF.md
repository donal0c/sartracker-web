...
- **Breadcrumb PR-3 final review restart (2026-08-25):** branch `codex/breadcrumb-pr3-complete-coverage` remains based on exact PR-2 merge `7021fc1e`. G2 selected Candidate B with ratified 1.5 GiB/2.5 GiB budgets; G3 approved the combined defaults, isolated in `b9bad64`. T1 migration/package/soak evidence stands. The first review wave's eight production-path blockers were reproduced red-first and remediated. Final pushed production code passed 257 files / 1,998 unit tests, static/build/Dots, Chromium 157/157, coverage visuals 4/4 and fresh critical review 6/6, macOS/Linux packaging, plus exact Ubuntu production delivery: 960k at 2.234 s first-useful / 5.677 s complete / 24.426 ms main gap and 2M at 4.472 s / 11.775 s / 30.982 ms. Exact totals delivered; the intentional incomplete-backfill fixture correctly prevented false Complete. Binding: `docs/breadcrumb-pr3-t1-evidence.md` and `output/pr3-production-qualification/`. Next: five independent reviews restart on the documentation-complete exact head; any P1/P2 remediation creates a new head and restarts all five.
