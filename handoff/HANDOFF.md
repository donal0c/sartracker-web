...
- `DON-27` — S8b: Add non-WebGL Leaflet raster fallback spike. Done locally 2026-05-31; read-only fallback proved behind `?mapRenderer=leaflet`.
...
Most recent verification in this turn (`DON-71` casualty treatment update log):
