...
- **PR5 current review candidate (2026-08-29):** the first review wave on exact pushed head `75a4ee05` was invalidated by three centrally accepted P2s. Persistence/completeness found an unbounded legacy event identity still read on main and a quarantined row in one mission blocking clean missions; broad life-safety found Finalize recovery could reuse an integrity-valid archive whose embedded event evidence was incomplete. Concurrency/finalization was clean; renderer review was not started after the candidate was already invalid. Executable fix `f5f0438eea7509a9c2b4eeb6bf3f551f2d0bf265` moves migration targets/cursors to bounded row IDs, explicitly quarantines oversized identities without retaining them in migration state, scopes quarantine custody fences to the affected mission, and rechecks all evidence readiness inside recoverable archive snapshots before reuse. Red tests reproduced all three defects. Local proof is green through serial unit 295 files / 2,495 tests, Chromium 167/167, backend 57/one intentional ignore, lint/build/CommonJS, indexed 960k and unsigned macOS arm64 package/8,664-position two-launch soak. Prior 58/58 visual plus uncached 69/69 screenshot review remains standing because this remediation has no visible renderer change. Exact branch-head Linux run [`33224611572`](https://github.com/donal0c/sartracker-web/actions/runs/33224611572) is green on `fb5f9636`: 2,495/2,495, Linux AppImage/`.deb`, native x86-64 SQLite, 960k qualification/restart equality, packaged 8,664/8,664 soak, llvmpipe and real AppImage close. All four restarted exact-head reviews on one final code-and-documentation SHA remain mandatory. PR opened/review-ready is intermediate; do not merge or release.
