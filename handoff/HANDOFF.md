...
- **Breadcrumb PR-2 review-ready candidate (2026-08-23):** `codex/breadcrumb-pr2-mission-model` contains BCP-03/04/06 (`DON-270/271/272`) at software candidate `3638d7eb4671`: additive schema v9; explicit non-overlapping outings and Unassigned fixes; explicit device/group participants; observation-time group changes; resumable late-add backfill; grandfathered legacy/finalized provenance; >100 warn-and-proceed; selected-only evidence/map scope; and deterministic outing-shaped fixtures. `missionModel` remains internal and release-off. Full local software, visual, fixture, live GET-only, exact-head flag-off/flag-on macOS package/restart-soak, and 100×5,000 stationary gates are green. The exact Ubuntu x64 package migrated an integrity-`ok` 3,704,745,984-byte v8 derivative of the immutable field fixture to integrity-`ok` v9: 32/32 grandfathered participants, zero outings, 2,040,000/2,040,000 Unassigned fixes, 1.530 s Review, 1.054 ms main maximum during Review, 108.5 ms renderer maximum, and a 128 ms post-Review Diagnostics interaction. Binding report SHA-256: `71bc42c1b7490abc2762c167177a8770b239b323e5f19346d6b39d5344b41830`. PR-2 may now enter Donal's four exact-head reviews; do not merge or start PR-3 until those reviews and merge approval complete.
...
- **Breadcrumb coordination workflow:** one implementation task owns a complete PR; BCP units are internal TDD checkpoints. PR-2's Ubuntu gate is green; Donal may now start the four independent exact-head reviews.
