...
- **PR5 latest candidate is locally green after the `582fd79e` four-review rejection (2026-08-28):** broad, persistence, concurrency and renderer reviewers rejected that exact head despite green Linux. Central retrace accepted eight distinct defects: oversized legacy objects could lose their sole exact state; recoverable archives trusted corrupt files; direct archive allowed unlock writes; startup receipt recovery was synchronous; Replay and GPX cursors crossed query/mission boundaries; browser Replay bypassed packaged input bounds; and an open Review stayed editable after Finish. Executable replacement `c3d25973ae48af56a4e058219a4949456e352f25` fixes them red-first while current-position writes remain prioritized and finalized/archive writes stay fail-closed. Local proof: unit 294/2,473; backend 55/1 intentional ignore; lint/build/budgets; Chromium 167/167; visual 58/58; fresh uncached visual review 69/69; indexed 960k seek 67.41 ms, late page 49.88 ms, maximum concurrent current write 44.89 ms, event-loop gap 54.37 ms and exact restart equality; unsigned macOS arm64 package; packaged soak 6/6, 8,664/8,664 and 4.3 ms main maximum. Bind version/docs, push, exact-head Linux and all four fresh exact-head reviews remain mandatory. PR opened/review-ready is intermediate; do not merge or release.
