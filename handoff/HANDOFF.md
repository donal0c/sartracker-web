...
- **PR5 mission evidence and replay is in one final renderer-parity recheck:** heads `f87d75873f11d12d249e3afbc482703b25f99ff4`, `1b35786c5de35355724928354789d779a52d186c`, `77be02aec37da6e0e032e3921d4bd333b7e20d3f` and `d57084b95dd208f68690d367533238bbe42a734e` were rejected and every accepted finding was reproduced red. The last broad/renderer finding was that browser replay retained dated/static GPX at and after its retirement time; the harness now uses the packaged as-of retirement predicate. The focused harness and operator Chromium regressions are green, as are full unit 288/2,397, lint/build and Chromium 164/164. The previously qualified persistence/runtime tree passed backend 51/1 intentional ignore, visual 58/58 plus uncached independent visual 69/69, 960k/2m scale, macOS package/soak/forced-kill recovery, and exact-tree Linux workflow [`33124584731`](https://github.com/donal0c/sartracker-web/actions/runs/33124584731): x64 AppImage/`.deb`/native SQLite, llvmpipe, 960k qualification, 8,664-position packaged soak and graceful AppImage close. The task is not complete until broad, persistence/completeness, concurrency/finalization and renderer/input-containment reviews are clean on the replacement final head. Do not merge or release.
