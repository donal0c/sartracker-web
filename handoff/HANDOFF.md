...
- **PR5 latest candidate is locally green after review and Linux rejection (2026-08-28):** the accepted four-review wave rejected `582fd79e`; executable replacement `c3d25973` fixes all eight centrally accepted persistence, finalization, cursor/input and Review-phase defects. Its binding head `3e166b55` was then correctly rejected by Linux run `33197229099`: 2,472 tests passed, but the 50,000-object reconstruction heartbeat reached 217.40 ms against the unchanged less-than-200 ms gate. Correction `4eaaeb01` halves each durable object turn to 50 rows; the exact failing test passed five consecutive runs, the evidence-versioning file passed 58/58 and full unit passed 294/2,473. Earlier replacement proof remains green: backend 55/1; lint/build/budgets; Chromium 167/167; visual 58/58 and uncached review 69/69; indexed 960k; unsigned macOS arm64 package; packaged soak 6/6 and 8,664/8,664. Bind/push, fresh exact-head Linux and all four fresh exact-head reviews remain mandatory. PR opened/review-ready is intermediate; do not merge or release.
