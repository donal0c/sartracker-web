...
- **Breadcrumb PR-3 repaired application head packaged and in final bounded review (2026-08-26):** Exact application head `d21e5df7e2151e6c97e501a2a32894cda157a806` fixes both confirmed blockers: failed initial/anti-entropy history writes await exact-mission durable loss ownership before observations settle, and renderer incident scopes are revalidated inside the serialized finalization/outbox mutation. Green: affected 6/304, exact serial 274/2,269, lint/types/CJS/build/budgets, backend 51/51, Chromium 22/22, visual 4/4, and fresh critical visual review. Exact macOS/Linux packages are bound; Ubuntu packaged soak passed 6/6, 8,664/8,664, one restart, two Mesa llvmpipe WebGL launches, zero crashes, integrity/WAL `ok`, main max 9.335 ms, renderer max 83.600 ms, four healthy interactions, and zero redundant slope. Immutable evidence: `output/pr3-packaged-soak/d21e5df7e2151e6c97e501a2a32894cda157a806/`. Remaining: documentation/evidence-only binding, green exact-head CI, then one fresh broad plus persistence, concurrency, and renderer/input-containment rechecks. PR [#3](https://github.com/donal0c/sartracker-web/pull/3) remains **not merge-ready**; do not merge or release.
