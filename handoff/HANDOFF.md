...
- **PR5 mission evidence and replay is awaiting the final four-review wave:** heads `f87d75873f11d12d249e3afbc482703b25f99ff4`, `1b35786c5de35355724928354789d779a52d186c` and `77be02aec37da6e0e032e3921d4bd333b7e20d3f` were rejected and every accepted finding was reproduced red. Candidate `f2f5330b9f124dff4cacbe66aa9b06e408030d4b` fixes retained-byte reconciliation and browser known-at-T parity. Its exact code/documentation tree passed unit 288/2,396, backend 51/1 intentional ignore, lint/build, Chromium 163/163, visual 58/58 plus uncached independent visual 69/69, 960k/2m scale, macOS package/soak/forced-kill recovery, and exact-tree Linux workflow [`33124584731`](https://github.com/donal0c/sartracker-web/actions/runs/33124584731): 2,396 tests, x64 AppImage/`.deb`/native SQLite, llvmpipe, 960k qualification, 8,664-position packaged soak and graceful AppImage close. The task is not complete until broad, persistence/completeness, concurrency/finalization and renderer/input-containment reviews are clean on the final documentation-binding descendant. The final handoff must name every reviewer/task, SHA, verdict, finding disposition and recheck. Do not merge or release.
