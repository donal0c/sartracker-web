...
- **PR5 pushed head `6642e383` is rejected (2026-08-28):** the preceding SQLx cancellation, 64 MiB quarantine and direct-archive fixes passed review, but persistence found settled legacy scan cost still grew to 291.82 ms at 500,000 rows and O(N2) across background turns. Concurrency reproduced an oversized fourth legacy row being overwritten before classification, permanently losing its 262,201-byte original. Red-green replacement work now uses a durable rowid scan target/cursor with bounded indexed seeks, fences every revisionless ID/path/presentation/outing/retirement target, and excludes unresolved content-hash alias candidates. The cursor regression failed red at 361.78 ms; the overwrite regression failed red by successfully publishing revision 2. Fresh proof is serial unit 289/2,424, backend 55/1 intentional ignore, lint/build/budgets, Chromium 165/165, visual 58/58, uncached review 69/69, and indexed/authentic-v11 960k gates green. Commit/push, fresh package/Linux and all four independent exact-head reviews remain mandatory. Do not merge or release.
