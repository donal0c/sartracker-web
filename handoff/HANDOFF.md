...
- **WAR-01 is at Donal's merge gate on [PR #6](https://github.com/donal0c/sartracker-web/pull/6) (2026-08-29):** PR5 merged as `eec92812b783a795c093f37268b295dd2179a3af`; the 40-row assurance register is reconciled to that base. `RPL-004` remains `rewrite-pending` until the programme PR-6 archive successor (`DON-248`/`DON-252`/`DON-253`) lands. Docs-only; do not merge or release from an agent task.
