...
- **Latest published beta:** `electron-v0.1.0-beta.9`, published 2026-07-08 after GitHub Actions run `28875685324` and a deep Ubuntu packaged smoke on the CI-built artifact (AppImage sha `99d3aeb3…`, deb sha `7d3490b4…`). Team artifact: https://github.com/donal0c/sartracker-web/releases/tag/electron-v0.1.0-beta.9 — supersedes beta.8. Release note: `docs/releases/sartracker-electron-0.1.0-beta.9.md`.
- **Previous beta:** `electron-v0.1.0-beta.8`, published 2026-06-23 after GitHub Actions run `28012741523` and a deep Ubuntu packaged smoke (43/43) on the CI-built post-fix artifact (AppImage sha `43067cb2…`). Team artifact: https://github.com/donal0c/sartracker-web/releases/tag/electron-v0.1.0-beta.8 — superseded by beta.9.
...
- **Fable deep-analysis remediation queue:** `DON-230` is the parent Linear issue for `output/fable-deep-analysis.md` (2026-07-06). `DON-231` through `DON-238` are complete and included in beta.9. `DON-239` is intentionally parked as low priority for a later tracking-staleness policy pass. Beta.9 release verification is complete: no-skip `npm run beta:verify` report `tmp/beta-artifacts/verify-0.1.0-beta.9-sha.581d43382545-2026-07-07T14-50-20Z.json`, visual E2E/review `34/34` and `39/39`, local browser and packaged smoke, GitHub Actions run `28875685324`, and Ubuntu CI-artifact smoke evidence under `output/beta9-ubuntu-smoke/`.
