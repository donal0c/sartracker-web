...
- **Hosted portfolio follow-up:** `DON-258` tracks a safe bare-root demo entry plus the 1280x720 mast-action crowding found during production validation; the hosted demo remains usable through the explicit harness URL.
