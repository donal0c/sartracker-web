...
- **Programme branch state (2026-08-29):** breadcrumb PR-1 through PR-5 are merged on `master`; PR-5 landed at `eec92812b783a795c093f37268b295dd2179a3af` from final head `f5ba8647131950dde457e50ce36fe0b8ded7337d`. PR-6 archive lifecycle is not implemented. WAR-13A is a docs-only protocol branch; it does not release a candidate or provide field proof.
...
- **Next programme implementation:** PR-6 owns archive streaming, custody, restore, archive-backed review, and indefinite-retention lifecycle. Until it is implemented and qualified, shadow sessions must not rely on current archive/restore behavior.
