...
- **Breadcrumb PR-3 final application head in review qualification (2026-08-26):** Exact application head `b42c57f844d7a434b2948e04e9fed1b2c3933453` contains the coherent deferred-evidence and crash-safe renderer-incident repair. Green: focused 6/231, adjacent 12/269, exact serial 274/2,265, lint/types/CJS/diff/build/budgets, backend 51/51, Chromium 22/22, visual 4/4, and one fresh critical visual review. Exact macOS/Linux packages are bound; Linux `app.asar` is `98046918...`, and the one replacement Ubuntu packaged soak passed 6/6, 8,664/8,664, one restart, zero crashes, integrity/WAL `ok`, main max 7.965 ms, renderer max 100.300 ms, four healthy interactions, and zero redundant slope. Immutable evidence: `output/pr3-packaged-soak/b42c57f844d7a434b2948e04e9fed1b2c3933453/`. Remaining: bind this evidence in a documentation-only commit, require green exact-head CI, then run exactly one fresh broad plus persistence, concurrency, and renderer-containment rechecks. PR [#3](https://github.com/donal0c/sartracker-web/pull/3) remains **not merge-ready**; do not merge or release.
